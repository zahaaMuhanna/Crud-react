...
import Input from './../../share/Share.jsx'
...
export default function Edit() {
  let [loader,setLoader] = useState(false);
   ...
   let [errorBack , setBackError] = useState('');
    const handleData=(e)=>{
    ...
    <div className="row flex-nowrap">  
      ...
      <div className="col py-3">
        ...
        <form onSubmit={sendData}>
            <Input errors={errors} id={'name'} value={user.name} title={'user name'} type={'text'} name={'name'} handleData={handleData}></Input>

            <Input  errors={errors} id={'email'} value={user.email} title={'user email'} type={'email'} name={'email'} handleData={handleData}></Input>

            <Input  errors={errors}id={'password'} value={user.password} title={'user password'} type={'password'} name={'password'} handleData={handleData}></Input>

        <div className="mb-3">
            <input type='submit' className='form-control' value='Save your change' />
        </div>
        </form>
      </div>
    </div>
