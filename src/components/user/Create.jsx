    ...
    <div className="row flex-nowrap">  
      ...
      <div className="col py-3">
        ...
        <form onSubmit={sendData}>
            <Input errors={errors} id={'name'} title={'user name'} type={'text'} name={'name'} handleData={handleData}></Input>

            <Input  errors={errors} id={'email'} title={'user email'} type={'email'} name={'email'} handleData={handleData}></Input>

            <Input  errors={errors}id={'password'} title={'user password'} type={'password'} name={'password'} handleData={handleData}></Input>
